// GET => accessing a node by POSITION in DoublyLinkedList
...
console.log('RETRIEVED NODE: ',list.get(1))
console.log('RETRIEVED NODE: ',list.get(0))
console.log('RETRIEVED NODE: ',list.get(2))
console.log('RETRIEVED NODE: ',list.get(-1))